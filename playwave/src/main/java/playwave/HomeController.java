...
public class HomeController implements Initializable {
     ...
     * @throws IOException
     */
    public void showPlaylistView(Playlist playlist) throws IOException, SQLException {
    ...
    public void setTrackData() throws SQLException {
        ...
        // If it doesn't show anything in the trackName is because the MetaData
        // of the selected track, at least the title is Unknown or Empty
        // so it doesn't take nothing
        if (selectedTrack.getArtist() != null) {
            trackName.setText(selectedTrack.getTitle() + " - " + selectedTrack.getArtist());
        }else{
